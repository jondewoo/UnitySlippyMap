...
namespace UnitySlippyMap.Input
{
	...
	public static class MapInput
	{
	    ...
	    private static bool panningStopped;
        private static Vector3 screenPosition = Vector3.zero;
	    private static bool zooming;
	    private static bool zoomingStopped;
                ...
                || Application.platform == RuntimePlatform.Android)
            {
                    ...
                    if (touchCount > 1)
                    {
                        ...
                        for (int i = 0; i < touchCount; ++i)
                        {
                            ...
                            if (touch.phase != TouchPhase.Ended)
                            {
                                zoomFactor += Vector3.Distance(screenPosition,
